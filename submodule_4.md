  ...
  <script>
    ...
    function showCongrats() {
      ...
      msg.innerHTML = `<div style="background: #6a75c8ff;padding:36px 32px 28px 32px;border-radius:18px;box-shadow:0 8px 32px #353e7444;text-align:center;max-width:420px;">
        ...
        <div style='font-size:1.1rem;color:#033e61;margin-bottom:18px;'>You defended Media Literacy Planet.<br><b>The shield level is now 4.</b></div>
        <div style='font-size:1.05rem;color: #a3cbf5ff;margin-bottom:18px;'>The code for the vault is: <b>1045</b>!</div>
